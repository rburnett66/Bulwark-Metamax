...
// THE CARVE IS THE MODEL. The edit overlay is gone; nothing is layered on top of the carve.
...
function renderGridView() {
  ...
  // cache the carve — it IS the model
  ...
  // ONE MODEL: the grid reads the carve, exactly as the 3D view does.
