...
.bw-bottombar { position:absolute; right:6px; bottom:calc(52px + env(safe-area-inset-bottom, 0px)); display:none; flex-direction:column; gap:8px; align-items:flex-end;
...
.bw-minimap { position:absolute; left:6px; bottom:calc(6px + env(safe-area-inset-bottom, 0px)); width:128px; height:64px;
  background:rgba(8,12,16,0.82); border:1px solid #2a3a4a; border-radius:4px; z-index:60; image-rendering:pixelated; }
.bw-gear { position:absolute; right:6px; bottom:calc(6px + env(safe-area-inset-bottom, 0px)); pointer-events:auto; z-index:66;
...
.bw-fs { position:absolute; right:50px; bottom:calc(6px + env(safe-area-inset-bottom, 0px)); pointer-events:auto; z-index:66;
  background:rgba(10,16,22,0.9); border:1px solid #4a6076; border-radius:6px; color:#cfe3f0;
